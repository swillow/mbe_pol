...
public:
  ...
  arma::mat getF(arma::mat &Fm, arma::mat &Dm) {
    ...
    arma::mat FmNew(Fm.n_rows, Fm.n_cols, arma::fill::zeros);
    ...
    if (false) {
      ...
      arma::mat B(N + 1, N + 1, arma::fill::zeros);
      // RHS vector
...
private:
  ...
  std::deque<arma::mat> FmList_;
  std::deque<arma::vec> ErrList_;
};
